...
| 502 / model error | Check Vercel logs `detail` — invalid model name or API not enabled |
| 429 / temporary unavailable | Quota/billing on this key — use the working site's API key, enable billing on the GCP project, redeploy |
