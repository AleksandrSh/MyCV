...
- Atsets: a job search engine I built that continuously indexes open roles directly from company ATS platforms, making hundreds of thousands of current jobs searchable in one place. It supports saved jobs and search alerts. https://atsets.com/
- Research Talent Dashboard Chrome extension: finds AI researchers through their public research footprint; uses candidate lookup and area search with sources like Semantic Scholar and OpenAlex to surface papers, authorship signals, expertise areas, affiliations, and follow-up review links. Chrome Web Store: https://chromewebstore.google.com/detail/research-talent-dashboard/pianlnkgeckobpokoecnfohfhicbohej
- GitHub Contributors Extractor Chrome extension: finds GitHub contributors by location to help recruiters and sourcers identify technical talent from open-source repositories. Chrome Web Store: https://chromewebstore.google.com/detail/github-contributors-by-lo/iaceidfhhdhmjiikkgkokdmgalkikjgc?utm_source=mycv&utm_medium=portfolio&utm_campaign=tools_built&utm_content=github_contributors
...
Contact: alshabanov27@gmail.com`;
  // Hidden until public again: Cisco Silicon One Engineering Hub — candidate resource hub with Gemini AI tools (career path, architecture ELI5, interview prep).
}
